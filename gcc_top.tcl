...
#
# .tcl: Tcl script for re-creating project 'gcc_top'
#
# Generated by Vivado on Thu Sep 07 14:09:09 +0200 2023
...
set proj_dir "gcc_top"
set orig_proj_dir [file normalize $origin_dir/$proj_dir]
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: gc_customIP_0, and set properties
  set gc_customIP_0 [ create_bd_cell -type ip -vlnv asdf:user:gc_customIP:1.0 gc_customIP_0 ]
  set_property -dict [ list \
   CONFIG.C_GRAY_COUNTER_TYPE {0} \
 ] $gc_customIP_0
  ...
  connect_bd_intf_net -intf_net gcc_customIP_0_M00_AXIS [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD] [get_bd_intf_pins gc_customIP_0/M00_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets gcc_customIP_0_M00_AXIS] [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_intf_net -intf_net jtag_axi_0_axi_periph_M00_AXI [get_bd_intf_pins gc_customIP_0/S00_AXI] [get_bd_intf_pins jtag_axi_0_axi_periph/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets jtag_axi_0_axi_periph_M00_AXI] [get_bd_intf_pins jtag_axi_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_net -net rst_ps8_0_99M_interconnect_aresetn [get_bd_pins jtag_axi_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins rst_ps8_0_99M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins gc_customIP_0/m00_axis_aresetn] [get_bd_pins gc_customIP_0/s00_axi_aresetn] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins jtag_axi_0_axi_periph/M00_ARESETN] [get_bd_pins jtag_axi_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins gc_customIP_0/i_rst] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins gc_customIP_0/i_clk] [get_bd_pins gc_customIP_0/m00_axis_aclk] [get_bd_pins gc_customIP_0/s00_axi_aclk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins jtag_axi_0_axi_periph/ACLK] [get_bd_pins jtag_axi_0_axi_periph/M00_ACLK] [get_bd_pins jtag_axi_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs gc_customIP_0/S00_AXI/S00_AXI_reg] SEG_gcc_customIP_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_fifo_mm_s_0/S_AXI/Mem0] SEG_axi_fifo_mm_s_0_Mem0
